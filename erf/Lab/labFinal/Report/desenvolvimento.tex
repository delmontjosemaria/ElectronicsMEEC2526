...
do circuito da figura \ref{fig:lna_ltspice} para o símbolo \texttt{LNA_lab1_adap}, utilizado para facilitar a análise. Nesta fase, o foco primário não eram os parâmetros S, mas os \textit{noise figure} e ganho do circuito. 
