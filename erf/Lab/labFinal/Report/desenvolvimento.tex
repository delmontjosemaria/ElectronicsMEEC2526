...
(\textit{normalized resistance noise}) é relativamente baixo para a frequência designada, o que indica que o ruído não deverá apresentar grandes oscilações da \textit{noise figure} para adaptações menos precisas em torno do ponto $\Gamma_{\text{min}}$, o que é benéfico
