...
frequência de calibração de 5\,GHz.
...
CMOS sob o fator de escala de referência fixado em $N = 2{,}75$. Considerando que o consumo energético é calculado a partir de

\begin{equation}
    P_D = V_{DD} \times \sum_{1}^{N_{M,V_{DD}}} I_D
\end{equation}

em que os valores para a equação se encontram nas figuras~\ref{fig:op350_N275}, \ref{fig:op45_N275} e os .op extraídos do Cadence para a tecnologia de 65nm. 
...
Ruído Total                & 5,17038e-18      & 2.76958e-18 & 2,93664e-18 & V\textsuperscript{2}/Hz \\
\hline,
\end{tabular}
\end{table}
...
corrente eleva o ruído térmico induzido no dreno (\textit{channel thermal noise}). Em simultâneo, o ruído resistivo induzido na porta 
