...
% ==============================================
\section{Desenho do LNA com um transistor BFP420}
\label{sec:desenvolvimento1}
...
Podemos observar pela figura \ref{fig:gamma_appcad} que os valores são, em impedância $Z_{S}$ e $Z_{L}$:
\begin{center}
...
A partir da equação \ref{eq:gammaL_gammaS} e \ref{eq:zl_zs}, obtemos o coeficiente de reflexão de saída $\Gamma_L$, que corresponde a uma impedância de carga $Z_L = 0,67 + 0,52j$.
Com estes valores, foi realizada a adaptação do circuito. As características das linhas de transmissão e stubs podem ser vistas na figura \ref{fig:lna_LS_maxmatSchematic}.
